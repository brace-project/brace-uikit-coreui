...
/**
 * @var \Brace\UiKit\CoreUi\CoreUiConfig $config
 */

?>
<!DOCTYPE html>
<html lang="<?php txt($config->lang) ?>">
<head>
    <base href="./">
    <?php
    ...
    foreach ($config->cssLinkHead as $link) {
        el("link @href=? @rel=stylesheet", [$link]);
    }

    foreach ($config->jsLinkHead as $link) {
        el("script @src=?", [$link]);
    }
    ?>
...
<div class="c-sidebar c-sidebar-dark c-sidebar-fixed c-sidebar-lg-show" id="sidebar">
    <div class="c-sidebar-brand d-lg-down-none">
        <a class="c-sidebar-brand-full" width="118" height="46">
            ...
            <span><?php txt($config->brandName)?></span>
        </a>
...
<div class="c-wrapper c-fixed-components">
            ...
            <li class="c-header-nav-item dropdown">
                <a class="c-header-nav-link " data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                    <div class="c-avatar">
                        ...
                        if ($config->avatarSrc !== null) {
                            echo fhtml("img @c-avatar-img @src=? @alt=?", [$config->avatarSrc, $config->avatarName]);
                        } else {
                            echo fhtml("i @c-avatar-img @font-2xl @bi @bi-person-circle @alt=?", [$config->avatarName]);
                        }
    ...
    <?php
    foreach ($config->jsLinkFooter as $link) {
        el("script @src=?", [$link]);
    }
    ?>
</div>
